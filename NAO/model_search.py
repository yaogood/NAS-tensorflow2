...
from operations import WSAvgPool2d, WSMaxPool2d, WSReLUConvBN, WSBN, WSSepConv, FactorizedReduce, CalibrateSize, \
    AuxHeadCIFAR, AuxHeadImageNet, apply_drop_path


class Node(keras.Model):
    def __init__(self, prev_layers, channels, stride, drop_path_keep_prob=None, node_id=0, layer_id=0, num_cells=0,
                 steps=0):
