...
def load_structure_dataset(dataset_name):
    if dataset_name == 'coverType':
        return load_covertype()
    elif dataset_name == 'networkIntrusion':
        return load_intrusion()
    elif dataset_name == 'sensIT':
        return load_sensit()
    else:
        assert False, 'Structure dataset name error'
